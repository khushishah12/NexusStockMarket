...
import { Search, ArrowUpRight, ArrowDownRight, TrendingUp, Loader2 } from 'lucide-react';
...
export default function MarketsPage() {
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    if (e.key === 'ArrowDown') {
      ...
      navigateTo(results[selectedIndex].symbol);
  ...
  return (
    <PageTransition>
      <PageHeader
        ...
        subtitle="Search NSE / BSE stocks. Click any result to view detailed chart."
      />

      <GlassCard accent="neutral" className="mx-auto max-w-2xl">
